        ...
        headers: [
          {
            ...
            value: `
              ...
              font-src 'self' data:;
              connect-src 'self' https://www.green-community.app https://green-community.azurewebsites.net https://greencommunity-app.azurewebsites.net https://api.razorpay.com https://lumberjack.razorpay.com;

...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background group/calendar px-4 pt-6 pb-8 [--cell-size:--spacing(10)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent rounded-xl shadow-sm overflow-hidden",
      ...
      classNames={{
        ...
        table: "w-full border-collapse mt-1 mb-5 overflow-hidden",

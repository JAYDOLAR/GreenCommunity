...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-green-50 via-white to-white relative overflow-hidden">
      ...
      <header className="sticky top-0 z-50 glass border-b border-border/30 backdrop-blur-xl animate-fade-in-down">
        <div className="flex items-center justify-between px-4 sm:px-6 h-16">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <div className="flex items-center gap-2 sm:gap-3 group cursor-pointer">
              <img
                ...
                className="h-10 w-auto sm:h-12 sm:w-auto max-w-[140px] sm:max-w-[220px] object-contain"
              />
            </div>
          ...
          <div className="flex gap-2 sm:gap-3">
            <Link href="/login">
              <button className="border border-green-600 text-green-600 hover:bg-green-50 font-semibold px-3 sm:px-5 py-2 rounded-full shadow transition-all transform hover:scale-105 hover:shadow-lg duration-200 hover:underline text-sm sm:text-base" style={{fontFamily: "'Inter', sans-serif"}}>
                Sign In
              </button>
            </Link>
            <Link href="/Signup">
              <button className="bg-green-600 hover:bg-green-700 text-white font-semibold px-4 sm:px-6 py-2 rounded-full shadow transition-all transform hover:scale-105 hover:shadow-lg duration-200 hover:underline text-sm sm:text-base" style={{ fontFamily: "'Inter', sans-serif" }}>
                Sign Up
              </button>
            </Link>
          </div>
      ...
      {/* Hero Section */}
      <section className="w-full flex justify-center items-center py-4 sm:py-8 bg-transparent">
        <motion.div
          className="relative max-w-7xl w-full mx-auto rounded-2xl sm:rounded-3xl shadow-xl overflow-hidden border border-green-200 mx-4 sm:mx-auto"
          style={{
        ...
        >
          <div className="relative z-10 flex flex-col items-center px-4 sm:px-8 py-16 sm:py-30">
            <motion.h1
              className="text-center font-bold mb-6 sm:mb-8 font-sans"
              style={{
            ...
            <motion.div className="flex flex-col sm:flex-row gap-4 mb-8 sm:mb-10 justify-center px-4" variants={itemVariants}>
              <Link href = "/login">
              <button
                onClick={() => router.push('/Signup')}
                className="flex items-center justify-center px-4 sm:px-7 py-3 rounded-full shadow-md font-bold text-white text-sm sm:text-base hover:shadow-lg transition-all group w-full sm:w-auto"
                style={{
                  background: "linear-gradient(90deg, #07a27bff 0%)",
                  fontFamily: "'Inter', sans-serif",
                  fontWeight: 600,
              ...
              >
                ...
                <span className="ml-2" style={{ fontSize: "18px", color: '#fff' }}>→</span>
              </button>
              </Link>
              <Link href = "/login">
              <button
                onClick={() => router.push('/Signup')}
                className="bg-white border border-green-400 text-green-600 rounded-full shadow-md transition px-6 sm:px-8 py-3 hover:shadow-lg hover:bg-green-50 hover:underline w-full sm:w-auto"
                style={{
            ...
            <motion.div className="text-center text-gray-500 text-xs sm:text-sm mb-4 px-4" variants={itemVariants}>
              Trusted by environmentally conscious individuals and forward-thinking businesses
            </motion.div>
            <motion.div className="flex justify-center gap-8 sm:gap-20 text-green-600 text-xl sm:text-2xl items-center px-4" variants={itemVariants}>
              {/* Lucide Leaf Icon */}
      ...
      {/* Features Section */}
      <section className="w-full bg-white py-16 sm:py-36 relative z-10">
        ...
        <motion.div
          ...
          variants={containerVariants}
        >
          <motion.div className="mb-8 sm:mb-15 max-w-5xl mx-auto px-4 sm:px-5 -mt-8 sm:-mt-15" variants={itemVariants}>
            <h2 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-3 text-center sm:text-left leading-tight">Everything You Need for<br />Environmental Impact</h2>
            <p className="text-sm sm:text-base text-gray-500 text-center sm:text-left max-w-2xl mx-auto sm:mx-0">
              Comprehensive tools and community support for your sustainability journey.
            </p>
          </motion.div>
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-4 sm:gap-x-6 gap-y-6 sm:gap-y-8 px-4 sm:px-5 mt-2">
      ...
      <section className="bg-gray-50 py-12 sm:py-20">
        <div className="container mx-auto px-4">
          ...
          >
            <h3 className="text-base sm:text-lg font-semibold text-green-600 mb-2">Drive Real Change</h3>
            <h2 className="text-2xl sm:text-4xl font-bold text-gray-800 px-4">A Community Platform for Climate Action</h2>
          </motion.div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            ...
            >
              <Card className="p-6 sm:p-10 border border-gray-200 shadow-sm rounded-2xl bg-white flex flex-col h-full">
                <div>
                  <div className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Join 10,000+ Climate Champions</div>
                  <div className="text-gray-600 text-sm sm:text-base leading-relaxed mb-6 sm:mb-8">
                    Our community is growing, and so is our impact. Together, we're making a measurable difference for the planet.
        </div>
                </div>
                <div className="flex-1 flex flex-col items-center justify-center">
                  <div className="text-4xl sm:text-6xl font-bold text-gray-900 mb-2">10K+</div>
                  <div className="text-base sm:text-lg text-gray-500 mb-4 sm:mb-6">Climate Champions</div>
                  <div className="flex items-center gap-2 text-green-600 font-medium mt-2 text-sm sm:text-base">
            ...
            <div className="flex flex-col gap-6 sm:gap-8">
              ...
              >
                <Card className="p-6 sm:p-10 border border-gray-200 shadow-sm rounded-2xl bg-white flex flex-col h-full items-center text-center">
                  <div className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Average 30% Carbon Reduction</div>
                  <div className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 sm:mb-6">
                    Members consistently reduce their carbon footprint with our tools and insights.
                </div>
                  <div className="text-4xl sm:text-6xl font-bold text-gray-900 mb-2">30%</div>
                  <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-2 flex items-center justify-center">
                    <ArrowDownCircle className="w-8 h-8 sm:w-10 sm:h-10 text-green-600" />
              </div>
          </Card>
              </motion.div>
              <motion.div
              ...
              >
                <Card className="p-6 sm:p-10 border border-gray-200 shadow-sm rounded-2xl bg-white flex flex-col h-full items-center text-center">
                  <div className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Real-time Impact Tracking</div>
                  <div className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 sm:mb-6">
                    Monitor your sustainability journey with a personalized dashboard and reporting.
        </div>
                  <div className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-2 grid grid-cols-4 grid-rows-2 gap-1">
                    {[...Array(8)].map((_, i) => (
            ...
            <motion.div
              ...
              transition={{ duration: 0.5, delay: 0.3 }}
            >
              <Card className="p-6 sm:p-10 border border-gray-200 shadow-sm rounded-2xl bg-white flex flex-col h-full justify-center">
                          <div>
                  <div className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Your Complete Sustainability Toolkit</div>
                  <div className="text-gray-600 text-sm sm:text-base leading-relaxed mb-6 sm:mb-8">
                    From verified offsets to expert webinars and an MSME resource hub, all in one place.
                      </div>
                </div>
                <div className="flex flex-col gap-3 sm:gap-4">
                  <div className="flex items-center gap-3 p-2 sm:p-3 bg-white rounded-full border border-gray-200 hover:border-green-300 transition-colors">
      ...
      <section className="bg-gradient-to-r from-green-50 to-blue-50 py-12 sm:py-20">
        <div className="container mx-auto px-4">
          <motion.div
            className="text-center mb-8 sm:mb-16"
            initial={{ opacity: 0, y: 20 }}
            ...
            transition={{ duration: 0.5 }}
          >
            <h2 className="text-2xl sm:text-4xl font-bold mb-4 text-gray-800 px-4">Stories from Our Community</h2>
          ...
          >
            {testimonials.map((testimonial, index) => (
              <motion.div key={index} variants={itemVariants}>
                <Card className="p-4 sm:p-6 hover:shadow-xl transition-all duration-500 hover:-translate-y-2 border-0 shadow-lg h-full">
              <CardContent className="space-y-3 sm:space-y-4">
                    <div className="flex items-center gap-3 sm:gap-4">
                      <img
                        src={testimonial.avatar}
                        alt={testimonial.name}
                        className="w-10 h-10 sm:w-12 sm:h-12 rounded-full object-cover ring-2 ring-green-200"
                      />
                      <div>
                    ...
                    <Badge variant="secondary" className="w-fit bg-green-100 text-green-800 border-green-200 text-xs">
                      {testimonial.badge}
                    </Badge>
      ...
      <motion.section
        className="w-full min-h-[300px] sm:min-h-[400px] flex items-center justify-center"
        style={{
      ...
      >
        <div className="max-w-2xl mx-auto text-center px-4 py-16 sm:py-24">
          <motion.h1
          ...
          <motion.p
            className="text-base sm:text-lg mb-6 sm:mb-8 text-white/80 font-medium px-4"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          <motion.div
            className="flex flex-col sm:flex-row gap-4 justify-center mb-6 px-4"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            <Link href="/Signup">
              <button 
                className="bg-white text-green-700 font-semibold px-4 sm:px-6 py-3 rounded-lg shadow hover:bg-gray-100 transition cursor-pointer hover:underline w-full sm:w-auto"
              >
                Start My Assessment
              </button>
            </Link>
            <Link href="/marketplace">
              <button 
                className="bg-transparent border border-white text-white font-semibold px-4 sm:px-6 py-3 rounded-lg shadow hover:bg-white hover:text-green-700 transition cursor-pointer hover:underline w-full sm:w-auto"
              >
          ...
          <motion.div
            className="text-xs sm:text-sm text-white/70 px-4"
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            viewport={{ once: true }}
      ...
      <footer className="bg-white border-t py-8 sm:py-12">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex-1 min-w-[250px] mb-6 sm:mb-8">
            <div className="flex items-center gap-2 mb-2">
              <img src="/logo.png" alt="GreenCommunity Logo" className="h-10 sm:h-12" />
            </div>
            ...
            <div>
              <div className="font-semibold text-sm sm:text-base text-gray-900 mb-1" style={{ fontFamily: "'Inter', sans-serif" }}>Get sustainability tips and community updates</div>
              <form className="flex flex-col sm:flex-row gap-2 mb-6 sm:mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8 px-4 sm:px-8">
            <div>
              <div className="font-bold mb-2 text-gray-900 text-sm sm:text-base" style={{ fontFamily: "'Inter', sans-serif" }}>Platform</div>
              <ul className="text-xs sm:text-sm text-gray-600 space-y-1" style={{ fontFamily: "'Inter', sans-serif" }}>
            ...
            <div>
              <div className="font-bold mb-2 sm:mb-3 text-gray-900 text-sm sm:text-base" style={{ fontFamily: "'Inter', sans-serif" }}>Resources</div>
              <ul className="text-xs sm:text-sm text-gray-600 space-y-1" style={{ fontFamily: "'Inter', sans-serif" }}>
            ...
            <div>
              <div className="font-bold mb-2 text-gray-900 text-sm sm:text-base" style={{ fontFamily: "'Inter', sans-serif" }}>Support</div>
              <ul className="text-xs sm:text-sm text-gray-600 space-y-1" style={{ fontFamily: "'Inter', sans-serif" }}>
            ...
            <div>
              <div className="font-bold mb-2 text-gray-900 text-sm sm:text-base" style={{ fontFamily: "'Inter', sans-serif" }}>Company</div>
              <ul className="text-xs sm:text-sm text-gray-600 space-y-1" style={{ fontFamily: "'Inter', sans-serif" }}>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between text-xs sm:text-sm text-gray-400" style={{ fontFamily: "'Inter', sans-serif" }}>

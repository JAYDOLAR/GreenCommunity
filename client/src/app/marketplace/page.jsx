...
export default function MarketplacePage() {
  ...
  return (
    <div className="p-8 space-y-8 bg-gradient-to-br from-background via-accent/5 to-primary/5 min-h-screen">
      {/* Header */}
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-bold text-gradient">Carbon Offset Marketplace</h1>
          <p className="text-lg text-muted-foreground">Invest in verified carbon offset projects worldwide</p>
        </div>

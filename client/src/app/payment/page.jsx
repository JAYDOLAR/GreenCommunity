...
const Payment = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 dark:from-gray-900 dark:via-emerald-900/20 dark:to-gray-900 p-0 overflow-x-hidden">
      ...
      <div className="max-w-full px-6 py-8 space-y-8 relative z-10">
        {/* Enhanced Header */}
        <div className="text-center space-y-4">
          <Button variant="ghost" onClick={() => router.back()} className="absolute left-0 top-0">
            <ArrowLeft className="h-4 w-4 mr-2" />
            Back to Projects
          </Button>
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-100 dark:bg-green-900/30 rounded-full">
            <Leaf className="h-5 w-5 text-green-600" />
            <span className="text-sm font-medium text-green-700 dark:text-green-300">Climate Action Payment</span>
          </div>
                ...
                <RadioGroup value={paymentMethod} onValueChange={setPaymentMethod} className="space-y-4">
                  {paymentMethods.map(method => {
                    ...
                    return (
                      <div 
                        key={method.id} 
                        className={`relative p-4 border-2 rounded-xl transition-all duration-300 cursor-pointer hover:shadow-lg ${
            ...
            {paymentMethod === 'upi' && (
              <Card className="border-0 shadow-xl bg-gradient-to-br from-white to-green-50 dark:from-gray-800 dark:to-green-900/20">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="text-center space-y-4">
                    <div className="flex justify-center">
                      <Button
                        ...
                        className="bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white px-6 py-3 rounded-xl flex items-center gap-3 shadow-lg"
                      >
                    ...
                    {showQR && qrCodeUrl && (
                      <div className="bg-white p-6 rounded-2xl shadow-lg border-2 border-green-200 inline-block">
                        <div className="space-y-4">
                          ...
                          <div className="text-center space-y-2">
                            ...
                            <p className="text-xs text-green-700 font-semibold">UPI ID: {UPI_ID}</p>
                  ...
                  {/* Manual UPI Entry */}
                  <div>
                    <Label htmlFor="upiId" className="text-sm font-medium">Enter UPI ID Manually</Label>
                    <Input
                      id="upiId"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {[
                        ...
                        <Button 
                          key={app.name} 
                          variant="outline" 
                          className={`h-12 bg-gradient-to-r ${app.color} text-white border-0 hover:opacity-90 transition-opacity`}
                        >
                          {app.name}
                        </Button>
                      ))}
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card className="border-0 shadow-2xl bg-gradient-to-br from-emerald-50 to-green-100 dark:from-emerald-900/30 dark:to-green-900/20 sticky top-6 overflow-hidden">
              ...
              <CardContent className="space-y-6 relative">
                {/* Impact Metrics */}
                <div className="space-y-4">
                  <div className="relative p-6 bg-gradient-to-r from-emerald-500 to-green-500 rounded-2xl text-white overflow-hidden">
                  ...
                  <div className="relative p-6 bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl text-white overflow-hidden">
                ...
                {/* Project Info */}
                <div className="space-y-3 p-4 bg-white/50 dark:bg-gray-800/50 rounded-xl backdrop-blur-sm">
                  <h4 className="font-semibold text-lg">Supporting Project</h4>
                ...
                <Button 
                  className="w-full h-14 text-lg font-semibold bg-gradient-to-r from-emerald-500 to-green-500 hover:from-emerald-600 hover:to-green-600 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105" 
                ...
                {/* Security Notice */}
                <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground p-3 bg-white/30 dark:bg-gray-800/30 rounded-lg backdrop-blur-sm">
